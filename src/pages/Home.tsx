...
const MATCH_TIMEOUT = 5000; // 5 seconds to find match
...
const Dashboard = () => {
  ...
  // Filter mock listings based on search query
  ...
  // Request a match for the selected skill
  ...
  // Poll for matches every 2 seconds while searching
  useEffect(() => {
  ...
  // Listen for new matches via Realtime (fallback for when user is not actively searching)
  useEffect(() => {
    if (!user) return;
  ...
  // Initialize user and skills on mount
  useEffect(() => {
    fetchUser();
    fetchSkills();
  }, []);
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <div className="absolute top-full left-0 w-full text-center mt-2 font-mono text-sm pointer-events-none">
              ...
              {matchFound && <div className="text-green-500">✅ Matched with {matchFound.username}!</div>}
            </div>
          </div>
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* User skills and statistics section */}
